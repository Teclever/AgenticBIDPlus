...
function halStats() {
  return {
    ...
    counts: {
      ...
      new: 28,
      accepted: 3,
      scoreBelow4New: 15, scoreBelow4Accepted: 2,
      scoreExact4New: 8,  scoreExact4Accepted: 1,
      scoreExact5New: 6,  scoreExact5Accepted: 0,
      highPriority: 14,
      closingSoon: 6,
...
function isroStats() {
  return {
    ...
    counts: {
      ...
      new: 32,
      accepted: 4,
      scoreBelow4New: 19, scoreBelow4Accepted: 2,
      scoreExact4New: 9,  scoreExact4Accepted: 1,
      scoreExact5New: 7,  scoreExact5Accepted: 1,
      highPriority: 16,
      closingSoon: 7,
